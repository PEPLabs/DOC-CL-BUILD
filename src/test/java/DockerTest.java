...
//        remove all images
    ...
    /**
     * read until the first non-commented line, and verify that some image exists named 'myimage'
     * @throws IOException
     * @throws InterruptedException
     */
    @Test
...
//      verify that 'alpine' is in the list of images.
        Assert.assertTrue(images.contains("myimage"));
    }
    /**
...
//      verify that there is an 'alpine' container
        Assert.assertTrue(containers.contains("myimage"));
    }
}
